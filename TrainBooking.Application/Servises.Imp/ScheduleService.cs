...
namespace TrainBooking.Application.Servises.Imp
{
    public class ScheduleService : IScheduleService
    {
        ...
        public Task<IEnumerable<ScheduleEntity>> GetTrainScheduleAsync(string cityFrom, string cityTo, DateTime date)
        {
          return _scheduleRepository.GetTrainSchedule(cityFrom, cityTo, date);
        }

        public Task<IEnumerable<ScheduleTransitEntity>> GetTrainScheduleByCityAndDateAsync(string city, DateTime date, bool isArrival)
        {
